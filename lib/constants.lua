...
constants.CAR_AVOIDANCE_MAX_SPEED = 0.15
constants.CAR_BLOCKED_TICKS = 180
constants.CAR_PATH_CLEARANCE = 0.8
constants.CAR_MAX_COLLISIONS = 3
...
constants.MINER_ORE_ARRIVAL_DISTANCE = 0.9
constants.MINER_STANDING_OFFSET = 0.5
